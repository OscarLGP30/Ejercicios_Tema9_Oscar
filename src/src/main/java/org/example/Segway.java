...
public class Segway {
    ...
    //Constructor
    public Segway(String marca, String modelo, int fechaCompra, int velocidad, double tarifaAlquiler, int autonomia, int tiempoAutonomia, int alturaMinima) {
        this.marca = marca;
        this.modelo = modelo;
    ...
    public Segway(String segway, String modelo, LocalDate of, int velocidad, double tarifaAlquiler) {
